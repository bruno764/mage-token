    ...
    if (activeTab === "telegram") {
      return (
        <div className="space-y-6">
          {/* ...Tudo do disparo via Telegram aqui... */}
    
          {/* Histórico da conta Telegram atual */}
          <div>
            <h3 className="text-xl font-bold mt-10 mb-2">📜 Histórico de Envios</h3>
                  ...
                  <tbody>
                    {broadcastHistory.map((item, i) => (
                      <tr key={i} className="border-t border-gray-700">
                        ...
                        <td className="px-4 py-2">{item.file_key ? "✅" : "—"}</td>
